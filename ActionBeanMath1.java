...
public class ActionBeanMath1 {
	...
	public void init() {
		...
		databaseImport = (DatabaseImport) m.get("databaseImport");
		

	}


	public ActionBeanMath1() {
		descrStatsBean = null;
...
descrStatsBean.setDataset(databaseImport.getFileLabel());
